...
public:
	...
	// eye tracking
	bool isEyetrackingAvailable() const override { return eyetracking.isEyetrackingAvailable(); }
...
private:
	...
	int openvr_getControllerDPadPressed(int device, int button);
